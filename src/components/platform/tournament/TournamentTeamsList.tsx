...
function TeamPreviewScreen({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-[#050505]/97 backdrop-blur-md animate-in fade-in duration-200">
            ...
            >
              ...
              <dl className="mt-4 space-y-2.5 text-sm">
                <div className="flex justify-between gap-4">
                  ...
                  <dd className="font-mono font-medium text-[var(--color-brand)]/90">
                    {player.accountId ?? "—"}
                  </dd>
                </div>
                <div className="flex justify-between gap-4">
