              ...
              {VALORANT_ROLE_OPTIONS.map((role) => {
                ...
                return (
                  <button
                    ...
                    className={`inline-flex items-center gap-2 rounded-xl border px-3.5 py-2 text-xs font-semibold transition-all duration-300 cursor-pointer ${
                      isSelected
                        ? "border-[#ff4655]/50 bg-[#ff4655]/15 text-white shadow-[0_0_12px_rgba(255,70,85,0.15)]"
                        : "border-white/10 bg-white/5 text-white/60 hover:border-white/20 hover:bg-white/10"
                    }`}
                  >
                    <ValorantRoleIcon role={role} className="h-4 w-4" />
