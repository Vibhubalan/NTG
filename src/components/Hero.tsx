export default function Hero() {
  return (
    ...
    >
      ...
      <span
        aria-hidden
        className="text-outline pointer-events-none absolute left-1/2 top-[58%] z-0 -translate-x-1/2 -translate-y-1/2 select-none whitespace-nowrap font-display text-[28vw] font-black leading-none tracking-[-0.06em] sm:text-[22vw] md:text-[18vw]"
      >
        NTG
      </span>

      <div className="relative z-10 flex flex-col items-center px-6 text-center">
        <span className="glass mb-9 flex items-center gap-2.5 rounded-full px-4 py-1.5 text-[10px] font-medium uppercase tracking-[0.4em] text-[var(--color-brand)]/90">
          <svg
            viewBox="0 0 24 24"
            aria-hidden
            className="h-3 w-3"
