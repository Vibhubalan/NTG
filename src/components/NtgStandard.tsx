        ...
        <div className="md:col-span-3">
          ...
          >
            {letters.map((l) => (
              ...
              >
                <span className="text-outline w-[2.5ch] shrink-0 font-display text-7xl font-black leading-none tracking-[-0.05em] transition-colors duration-500 group-hover:[-webkit-text-stroke:1px_var(--color-brand)] sm:text-8xl">
                  {l.letter}
                </span>
